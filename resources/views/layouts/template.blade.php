								...
								@else
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
											...
											<a class="dropdown-item" href="{{ route('company.job.posted.show', Auth::guard('company')->user()) }}">Dashboard</a>
								...
								<div class="col-lg-12">
									<div class="row">
										<div class="col-lg-9 col-md-9 col-sm-12 p-md-0 p-lg-0 m-b-2">
											<div class="mr-r">
												{{-- <input type="text" name="q" class="form-control search-form" placeholder="Enter your Keyword" required> --}}
										...
										{{-- <div class="col-lg-3 col-md-3 col-sm-12 p-md-0 p-lg-0">
											<div class="mr-r"><input type="text" class="form-control search-form" placeholder="All Type">
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 p-md-0 p-lg-0">
											<div class="mr-r">
												<select class="form-control search-form" id="exampleFormControlSelect1">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-r footer-list mob-12" >
							<li ><a style="color: #000;" href="{{ url('privacy') }}">Privacy Policy</a></li>
							

						</div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 footer-list mob-12">
						<li><a style="color: #000;" href="{{ url('terms') }}">Terms and Conditions</a></li>
						</div>
					</div>
